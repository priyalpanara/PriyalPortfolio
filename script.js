$(document).ready(function(){
    ...
    var typed = new Typed(".typing", {
        strings: ["Web Development","ReactJs Development", "Software Development","Frontend Development", "Designing", "UI designing" ],
        typeSpeed: 100,
        backSpeed: 60,
        loop: true
    });
    ...
    var typed = new Typed(".typing-2", {
      strings: ["Web Development" ,"ReactJs Development", "Designing", "UI designing", "Frontend Development","Software Development"],
...
const plusIcons = document.querySelectorAll('.arrow-button');
